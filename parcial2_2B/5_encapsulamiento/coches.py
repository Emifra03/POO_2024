...
class Coches:
    ...
    #Atributo pribado
    __atributo_privados="Soy un atributo provado"


    #Para utilizar un atributo provado es necesario hacer lo a traves de un metodo publico
    def getAtributoPrivado(self):
       return self.__atributo_privados
